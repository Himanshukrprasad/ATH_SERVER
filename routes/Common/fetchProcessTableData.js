  ...
  pool.getConnection((err, connection) => {
      ...
      connection.query(lastOperationQuery, [esVch], (error, results) => {
        ...
        connection.query(headerQuery, [esVch], (error, headerResults) => {
          ...
          else if (lastOperation === 'PRT') {
        
            const headerQuery = `
            SELECT vch_no
            FROM printing_rec_header
            WHERE estimate_cs_vch_no = ?
        `;
        ...
        connection.query(headerQuery, [esVch], (error, headerResults) => {
          ...
          else if (lastOperation === 'STICH') {
        
           
            const headerQuery = `
            SELECT vch_no
            FROM stitching_rec_header
            WHERE estimate_cs_vch_no = ?
        `;
        ...
        connection.query(headerQuery, [esVch], (error, headerResults) => {
            ...
            const sourceQuery = `
                SELECT *
                FROM stitching_rec_destination
                WHERE vch_no IN (?)
            `;
        ...
        connection.query(headerQuery, [esVch], (error, headerResults) => {
          ...
          else if (lastOperation === 'WASH') {
           
            const headerQuery = `
            SELECT vch_no
            FROM washing_rec_header
            WHERE estimate_cs_vch_no = ?
        `;
        ...
        connection.query(headerQuery, [esVch], (error, headerResults) => {
          ...
          else if (lastOperation === 'REFINISH') {
           
            const headerQuery = `
            SELECT vch_no
            FROM Refinishing_rec_header
            WHERE estimate_cs_vch_no = ?
        `;

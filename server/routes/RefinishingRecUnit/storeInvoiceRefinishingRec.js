...
router.post("/", async (req, res) => { 
  try {
    ...
    let embRecNoText = `RE/R/${refinishingRecContextUnitData.lastEmbRecNo}/${refinishingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        refinishingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',

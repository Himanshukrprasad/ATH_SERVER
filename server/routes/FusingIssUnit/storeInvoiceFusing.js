...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `FI/${fusingIssUnitData.lastFSNNo}/${fusingIssUnitData.embUnitData[0].embUnitVal}/24-25`;
    let unitNO = `FUSSING ISS -${fusingIssUnitData.embUnitData[0].embUnitVal}`

...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `I/I/${ironingIssContextUnitData.lastEmbNo}/${ironingIssContextUnitData.embUnitData[0].embUnitVal}/24-25`;
...
const filteredString = filteredValues.join(',');
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        embIssNoText || "NA",
        ironingIssContextUnitData.designNoData[0].estimate_cs_vch_no || 'NA',
        ...
        ironingIssContextUnitData.designIdVal || 'NA',
        ...
        if (
          ...
          for (let i = 0; i < ironingIssContextUnitData.sourceTableData.length; i++) {
            await connection.query(insertSourceQuery, [
              ...
              ironingIssContextUnitData.jwAmount || 0,
              ironingIssContextUnitData.sourceTableData[i].qty * ironingIssContextUnitData.jwAmount || 0  
            ]);
          }
        } else {
          console.error("Data is undefined or has an invalid length");

...
router.post("/", async (req, res) => {
  try {
    ...
    let embRecNoText = `PL/R/${pleatingRecContextUnitData.lastEmbRecNo}/${pleatingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        pleatingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',

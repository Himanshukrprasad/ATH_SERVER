...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `RE/I/${refinishingIssContextUnitData.lastEmbNo}/${refinishingIssContextUnitData.embUnitData[0].embUnitVal}/24-25`;
...
const filteredString = filteredValues.join(',');
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        refinishingIssContextUnitData.designIdVal || 'NA',

...
router.post("/", async (req, res) => { 
  try {
    ...
    let embRecNoText = `PR/R/${printingRecContextUnitData.lastEmbRecNo}/${printingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        printingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',

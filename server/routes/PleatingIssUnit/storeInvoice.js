...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `PL/I/${pleatingIssContextUnitData.lastEmbNo}/${pleatingIssContextUnitData.embUnitData[0].embUnitVal}/24-25`;
...
const filteredString = filteredValues.join(',');
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        pleatingIssContextUnitData.designIdVal || 'NA',

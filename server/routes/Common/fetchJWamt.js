...
//   let {jType, jobberName, SvchNo, processName } = req.body;
...
//       "SELECT amt FROM Estimated_CS_JW_Detail WHERE vch_no = ? AND jobber_name = ? AND is_other_charge = 0 AND jobwork_name LIKE ? AND type = ?",
//       [esVchVal, jobberName, `%${processName}%`, jType]
//     );
    
//     // Extract the single value
//     const jwAmount = estimatedCsJwDetailResult.length > 0 ? estimatedCsJwDetailResult[0].amt : null;

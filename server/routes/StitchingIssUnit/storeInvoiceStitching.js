...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `SI/${stitchingIssContextUnitData.lastEmbNo}/${stitchingIssContextUnitData.embUnitData[0].embUnitVal}/24-25`;
...
const filteredString = filteredValues.join(',');
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        stitchingIssContextUnitData.designIdVal || 'NA',

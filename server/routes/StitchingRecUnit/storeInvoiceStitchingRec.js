...
router.post("/", async (req, res) => { 
  try {
    ...
    let embRecNoText = `SR/${stitchingRecContextUnitData.lastEmbRecNo}/${stitchingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        stitchingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',

...
router.post("/", async (req, res) => {
  try {
    ...
    let embRecNoText = `FR/${fusingRecContextUnitData.lastEmbRecNo}/${fusingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        fusingRecContextUnitData.designIdVal || 'NA',
        unitNo || 'NA',

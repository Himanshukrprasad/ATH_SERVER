...
router.post("/", async (req, res) => { 
  try {
    ...
    let embRecNoText = `WR/${washingRecContextUnitData.lastEmbRecNo}/${washingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        washingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',

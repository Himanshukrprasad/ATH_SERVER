...
router.post("/", async (req, res) => {
  try {
    ...
    let embIssNoText = `WI/${washingIssContextUnitData.lastEmbNo}/${washingIssContextUnitData.embUnitData[0].embUnitVal}/24-25`;
...
const filteredString = filteredValues.join(',');
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        washingIssContextUnitData.designIdVal || 'NA',

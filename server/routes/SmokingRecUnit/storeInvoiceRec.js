...
router.post("/", async (req, res) => { 
  try {
    ...
    let embRecNoText = `SM/R/${smokingRecContextUnitData.lastEmbRecNo}/${smokingRecContextUnitData.embRecUnitData[0].embRecUnitVal}/24-25`;
    ...
    try {
      ...
      await connection.query(insertHeaderQuery, [
        ...
        smokingRecContextUnitData.designIdVal || 'NA',
        unitNO || 'NA',
